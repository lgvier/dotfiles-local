...
local log = hs.logger.new('hhtwm_shortcuts','debug')
-- local highlightWindow = require('ext.drawing').highlightWindow
local highlightWindow = function() end
local capitalize      = require('ext.utils').capitalize

local move = function(dir)
  local win = hs.window.frontmostWindow()
  local floating = hhtwm.isFloating(win)
  log.i('move win', win, 'floating?', floating, 'to', dir)
...
local resize = function(resize)
  local win = hs.window.frontmostWindow()
  log.i('resize win', win, 'arg', resize)
...
module.start = function()
  ...
  hs.alert.show("hhtwm_shortcuts started")
end

module.stop = function()
  hs.alert.show("hhtwm_shortcuts stopped")
end
